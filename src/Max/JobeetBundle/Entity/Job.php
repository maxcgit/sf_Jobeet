...
class Job
{
     ...
     * Set category
     *
     * @param \Max\JobeetBundle\Entity\Category $category
     * @return Job
     */
    public function setCategory(\Max\JobeetBundle\Entity\Category $category = null)
    {
     ...
     * Get category
     *
     * @return \Max\JobeetBundle\Entity\Category 
     */
