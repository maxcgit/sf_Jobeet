...
class CategoryRepositoryTest extends WebTestCase
{
    ...
    {
        $query = $this->em->createQuery('SELECT c FROM MaxJobeetBundle:Category c LEFT JOIN c.jobs j WHERE j.expires_at > :date');
        $query->setParameter('date', date('Y-m-d H:i:s', time()));
        $categories_db = $query->getResult();
 
        $categories_rep = $this->em->getRepository('MaxJobeetBundle:Category')->getWithJobs();
