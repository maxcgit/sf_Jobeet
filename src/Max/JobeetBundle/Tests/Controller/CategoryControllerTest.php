...
class CategoryControllerTest extends WebTestCase
{
    ...
    public function testShow()
    {
        ...
        $categories = $this->em->getRepository('MaxJobeetBundle:Category')->getWithJobs();
        ...
        foreach($categories as $category) {
            ...
            $this->assertEquals('Max\JobeetBundle\Controller\CategoryController::showAction', $client->getRequest()->attributes->get('_controller'));
            $this->assertEquals($category->getSlug(), $client->getRequest()->attributes->get('slug'));
 
            $jobs_no = $this->em->getRepository('MaxJobeetBundle:Job')->countActiveJobs($category->getId()); 
