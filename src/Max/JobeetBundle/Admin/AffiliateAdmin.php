...
namespace Max\JobeetBundle\Admin;
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add('_action', 'actions', array( 'actions' => array(
            	'activate' => array('template' => 'MaxJobeetBundle:AffiliateAdmin:list__action_activate.html.twig'),
                'deactivate' => array('template' => 'MaxJobeetBundle:AffiliateAdmin:list__action_deactivate.html.twig')
            )))
        ;
    }
